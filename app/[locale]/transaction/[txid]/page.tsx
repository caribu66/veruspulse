  ...
  const fetchTransaction = useCallback(async () => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        setError(result.error || tTransactions('unableToLoadTransaction'));
      }
    } catch (_err) {
      setError(tTransactions('unableToLoadTransaction'));
    } finally {
      setLoading(false);
    }
  }, [txid]);
          ...
          <div className="bg-gray-900 border border-gray-600 rounded-xl w-full mx-auto max-w-4xl p-6 shadow-2xl">
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">
                {tTransactions('transactionNotFound')}
              </h2>
              <p className="text-gray-400 mb-6">
                {error || tTransactions('unableToLoadTransaction')}
              </p>
            ...
            <div className="bg-gray-800/50 rounded-lg p-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  title={tTransactions('copyTransactionId')}
                >
                  {copied === 'txid' ? (
            ...
            {(transaction.time || transaction.blocktime) && (
              <div className="bg-gray-800/50 rounded-lg p-4">
                <div className="text-blue-200 font-semibold mb-2 text-sm flex items-center space-x-2">
                  ...
                  <span>{tTransactions('timestampLabel')}</span>
                </div>
            ...
            {transaction.fee !== undefined && transaction.fee > 0 && (
              <div className="bg-gray-800/50 rounded-lg p-4">
                <div className="text-blue-200 font-semibold mb-2 text-sm flex items-center space-x-2">
                  ...
                  <span>{tTransactions('transactionFee')}</span>
                </div>
                <div className="text-white font-semibold">
            ...
            <div className="bg-gray-800/50 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-bold text-white">
                  {tTransactions('inputsAndOutputs')}
                </h3>
              </div>
