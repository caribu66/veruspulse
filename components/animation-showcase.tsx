...
export function AnimationShowcase() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 min-h-screen p-8">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="bg-gray-800 rounded-lg p-4 font-mono text-sm">
                ...
                <div className="text-yellow-400">useNewBlockAnimations</div>
                <div className="text-white">();</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-800 rounded-lg p-4 font-mono text-sm">
                <div className="text-yellow-400">processNewBlocks</div>
          ...
          <div className="mt-8 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
            <p className="text-green-400 text-sm">
              <strong>Ready to use!</strong> Your existing LiveBlocksCard has
              been enhanced with these animations. Just refresh your app to see
              the new effects in action.
            </p>
          </div>
        </div>
      </div>
