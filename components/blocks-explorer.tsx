    ...
    <div className="space-y-6 text-gray-900 dark:text-white">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 md:p-6 border border-slate-300 dark:border-slate-700">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
          ...
          <div className="flex flex-wrap items-center gap-2 md:gap-3">
            ...
            <div className="flex items-center space-x-2">
              <Funnel className="h-4 w-4 text-slate-300" />
              <select
                value={filterType}
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={exportToCSV}
                className="px-3 py-1.5 bg-gradient-to-r from-slate-500/20 to-slate-600/20 hover:from-slate-500/30 hover:to-slate-600/30 text-slate-200 text-xs font-medium rounded-lg border border-slate-500/30 hover:border-slate-500/50 transition-all duration-200"
              >
                CSV
              </button>
              <button
        ...
        {blocks.length > 0 ? (
          ...
          <div className="text-center py-8 text-slate-300">No blocks found</div>
        )}
