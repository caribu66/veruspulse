...
class Mid2022GapScanner {
  constructor() {
    ...
    this.rpcDelay = 50; // Stable delay to prevent ENOBUFS
  ...
  async initialize() {
    console.log('🎯 MID 2022 GAP SCANNER');
    console.log('=======================');
    console.log('📍 Target: 2.4M to 2.5M (Mid 2022)');
  ...
  async getLastProcessedBlock() {
    try {
      ...
      return 2400000; // Start from beginning
    } catch (error) {
      console.log(
  ...
  async run() {
    try {
      ...
      const endBlock = 2500000; // End of Mid 2022

      if (startBlock > endBlock) {
        console.log('✅ Mid 2022 range already completed!');
        return;
      }
      ...
      console.log('');
      console.log('🎉 Mid 2022 gap scan completed!');
      console.log(
...
// Run the scanner
const scanner = new Mid2022GapScanner();
