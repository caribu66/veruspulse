...
/**
 * Oink70's Proven PoS Scanner
 * - Uses Oink70's proven PoS detection method
 * - Scans from December 2020 to current tip
 * - Finds ALL I-address stakes using correct logic
 * - Based on: https://github.com/Oink70/Verus-CLI-tools/blob/main/PoS-rewards.sh
 */

const { Pool } = require('pg');
const { execSync } = require('child_process');

class Oink70PoSScanner {
  constructor() {
    this.pool = new Pool({
      connectionString:
  ...
  async initialize() {
    console.log('🚀 OINK70 PROVEN PoS SCANNER');
    console.log('============================');
    console.log('');
    ...
    console.log('🎯 Finding ONLY true PoS blocks (validationtype="stake")');
  ...
  async isProofOfStakeBlock(block) {
    ...
    // This is the correct and proven way to detect PoS blocks in Verus
...
// Run the scanner
const scanner = new Oink70PoSScanner();
