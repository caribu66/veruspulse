    ...
    for (let h = height; h <= batchEnd; h++) {
      try {
        ...
        if (stats.blocksScanned % 500 === 0) {
          ...
          console.log(`\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
          console.log(`Blocks: ${stats.blocksScanned} | Stakes: ${stats.stakeEventsFound}`);
          console.log(`Speed: ${rate.toFixed(1)} blocks/sec | ETA: ${(eta / 60).toFixed(1)} min`);
          console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`);
        }
      } catch (error) {
...
async function main() {
  try {
    ...
    console.log(`   Block range: ${startHeight} to ${endHeight} (${blocksToScan} blocks)`);
    ...
    if (stats.stakeEventsFound > 0) {
      ...
      console.log('   Run: ./scripts/update-statistics.sh to calculate stats\n');
    } else {
      console.log('⚠️  No stakes found in this period. Try a longer period with:');
